...
00000ba0 <preempt>:
{
  ...
  kill(pid3);
     ...
     cb8:	e8 dd 32 00 00       	call   3f9a <kill>
  printf(1, "wait... ");
...
00000da0 <mem>:
{
  ...
  ppid = getpid();
     dbd:	e8 28 32 00 00       	call   3fea <getpid>
  ...
  if((pid = fork()) == 0){
    ...
    wait(0);
     ...
     e6f:	e8 26 31 00 00       	call   3f9a <kill>
      exit(0);
...
00000e80 <sharedfd>:
{
  ...
  for(i = 0; i < 1000; i++){
    ...
    if(write(fd, buf, sizeof(buf)) != sizeof(buf)){
     ...
     f0c:	e8 79 30 00 00       	call   3f8a <write>
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
     ...
     f8a:	e8 f3 2f 00 00       	call   3f82 <read>
  ...
  close(fd);
     ...
     fcf:	e8 be 2f 00 00       	call   3f92 <close>
  unlink("sharedfd");
     fd4:	c7 04 24 53 48 00 00 	movl   $0x4853,(%esp)
     fdb:	e8 da 2f 00 00       	call   3fba <unlink>
    ...
    107b:	31 db                	xor    %ebx,%ebx
{
  ...
  printf(1, "fourfiles test\n");
    ...
    10b3:	e8 02 2f 00 00       	call   3fba <unlink>
    pid = fork();
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    1125:	e8 80 2e 00 00       	call   3faa <open>
    ...
    12d6:	31 db                	xor    %ebx,%ebx
{
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    137a:	88 45 c9             	mov    %al,-0x37(%ebp)
      fd = open(name, 0);
    137d:	e8 28 2c 00 00       	call   3faa <open>
      if((i == 0 || i >= N/2) && fd < 0){
    ...
    13a4:	e8 e9 2b 00 00       	call   3f92 <close>
    for(pi = 0; pi < 4; pi++){
  ...
  for(i = 0; i < N; i++){
    ...
    13d7:	88 45 c9             	mov    %al,-0x37(%ebp)
      unlink(name);
    13da:	e8 db 2b 00 00       	call   3fba <unlink>
    for(pi = 0; pi < 4; pi++){
  ...
  for(i = 0; i < N; i++){
    ...
    148c:	88 45 c9             	mov    %al,-0x37(%ebp)
          if(unlink(name) < 0){
    148f:	e8 26 2b 00 00       	call   3fba <unlink>
    ...
    19e5:	31 f6                	xor    %esi,%esi
{
  ...
  for(i = 0; i < 40; i++){
    ...
    1a6f:	e8 46 25 00 00       	call   3fba <unlink>
    pid = fork();
    ...
    1aa6:	e8 1f 25 00 00       	call   3fca <link>
        exit(0);
  ...
  for(i = 0; i < 40; i++){
    ...
    1c48:	e8 6d 23 00 00       	call   3fba <unlink>
      unlink(file);
    1c4d:	89 1c 24             	mov    %ebx,(%esp)
    1c50:	e8 65 23 00 00       	call   3fba <unlink>
      unlink(file);
    1c55:	89 1c 24             	mov    %ebx,(%esp)
    1c58:	e8 5d 23 00 00       	call   3fba <unlink>
      unlink(file);
    1c5d:	89 1c 24             	mov    %ebx,(%esp)
    1c60:	e8 55 23 00 00       	call   3fba <unlink>
...
00001d30 <linkunlink>:
{
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1d98:	e8 1d 22 00 00       	call   3fba <unlink>
  for(i = 0; i < 100; i++){
    ...
    1dcc:	e8 d9 21 00 00       	call   3faa <open>
    1dd1:	89 04 24             	mov    %eax,(%esp)
    1dd4:	e8 b9 21 00 00       	call   3f92 <close>
  for(i = 0; i < 100; i++){
  ...
  printf(1, "linkunlink ok\n");
    ...
    1e1f:	e8 a6 21 00 00       	call   3fca <link>
    ...
    3365:	31 f6                	xor    %esi,%esi
{
  ...
  c = sbrk(1);
    ...
    33de:	e8 0f 0c 00 00       	call   3ff2 <sbrk>
  c = sbrk(1);
    33e3:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    33ea:	e8 03 0c 00 00       	call   3ff2 <sbrk>
  if(c != a + 1){
  ...
  a = sbrk(0);
    ...
    3415:	e8 d8 0b 00 00       	call   3ff2 <sbrk>
  amt = (BIG) - (uint)a;
  ...
  p = sbrk(amt);
    ...
    3426:	e8 c7 0b 00 00       	call   3ff2 <sbrk>
  if (p != a) {
  ...
  *lastaddr = 99;
  ...
  a = sbrk(0);
    ...
    347e:	e8 6f 0b 00 00       	call   3ff2 <sbrk>
  c = sbrk(4096);
    3483:	c7 04 24 00 10 00 00 	movl   $0x1000,(%esp)
  a = sbrk(0);
    348a:	89 c6                	mov    %eax,%esi
  c = sbrk(4096);
    348c:	e8 61 0b 00 00       	call   3ff2 <sbrk>
  ...
  if(c != a || sbrk(0) != a + 4096){
    ...
    34a2:	e8 4b 0b 00 00       	call   3ff2 <sbrk>
  ...
  if(pipe(fds) != 0){
    ...
    3536:	e8 3f 0a 00 00       	call   3f7a <pipe>
    ...
    3572:	e8 0b 0a 00 00       	call   3f82 <read>
  ...
  c = sbrk(4096);
    ...
    3588:	e8 65 0a 00 00       	call   3ff2 <sbrk>
    ...
    3599:	e8 fc 09 00 00       	call   3f9a <kill>
    wait(0);
  ...
  printf(stdout, "sbrk test OK\n");
    ...
    3632:	e8 53 09 00 00       	call   3f8a <write>
    3637:	90                   	nop
      for(;;) sleep(1000);
    ...
    3795:	31 db                	xor    %ebx,%ebx
{
  ...
  printf(stdout, "validate test\n");
    ...
    sleep(0);
    37c6:	e8 2f 08 00 00       	call   3ffa <sleep>
    sleep(0);
    37cb:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
    37d2:	e8 23 08 00 00       	call   3ffa <sleep>
    kill(pid);
    37d7:	89 34 24             	mov    %esi,(%esp)
    37da:	e8 bb 07 00 00       	call   3f9a <kill>
    wait(0);

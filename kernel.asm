...
801002c3:	e8 08 3b 00 00       	call   80103dd0 <sleep>
    while(input.r == input.w){
...
80101eec:	e8 6f e4 ff ff       	call   80100360 <panic>
    panic("dirlink");
80101ef1:	c7 04 24 86 76 10 80 	movl   $0x80107686,(%esp)
...
801020bc:	e8 cf 1e 00 00       	call   80103f90 <wakeup>
...
801021ab:	e8 20 1c 00 00       	call   80103dd0 <sleep>
  while((b->flags & (B_VALID|B_DIRTY)) != B_VALID){
...
80102b37:	e8 94 12 00 00       	call   80103dd0 <sleep>
    if(log.committing){
...
80102c8a:	e8 01 13 00 00       	call   80103f90 <wakeup>
    release(&log.lock);
...
8010328d:	e8 fe 0c 00 00       	call   80103f90 <wakeup>
  } else {
    p->readopen = 0;
    wakeup(&p->nwrite);
  }
...
801032cb:	e8 c0 0c 00 00       	call   80103f90 <wakeup>
...
8010334f:	e8 3c 0c 00 00       	call   80103f90 <wakeup>
      sleep(&p->nwrite, &p->lock);  //DOC: pipewrite-sleep
80103354:	89 5c 24 04          	mov    %ebx,0x4(%esp)
80103358:	89 34 24             	mov    %esi,(%esp)
8010335b:	e8 70 0a 00 00       	call   80103dd0 <sleep>
    while(p->nwrite == p->nread + PIPESIZE){  //DOC: pipewrite-full
...
801033ca:	e8 c1 0b 00 00       	call   80103f90 <wakeup>
  release(&p->lock);
...
8010341f:	e8 ac 09 00 00       	call   80103dd0 <sleep>
  while(p->nread == p->nwrite && p->writeopen){  //DOC: pipe-empty
...
801034a5:	e8 e6 0a 00 00       	call   80103f90 <wakeup>
  release(&p->lock);
...
80103505:	c7 43 0c 01 00 00 00 	movl   $0x1,0xc(%ebx)
  p->priority = 30;
8010350c:	c7 83 80 00 00 00 1e 	movl   $0x1e,0x80(%ebx)
80103513:	00 00 00 
  p->pid = nextpid++;
...
8010351f:	89 43 10             	mov    %eax,0x10(%ebx)
  release(&ptable.lock);
80103522:	e8 39 0f 00 00       	call   80104460 <release>
...
8010353e:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
80103541:	c7 40 14 f5 56 10 80 	movl   $0x801056f5,0x14(%eax)
...
8010355b:	89 43 1c             	mov    %eax,0x1c(%ebx)
  memset(p->context, 0, sizeof *p->context);
8010355e:	e8 4d 0f 00 00       	call   801044b0 <memset>
...
8010357f:	e8 dc 0e 00 00       	call   80104460 <release>
}
...
801035ad:	e8 ae 0e 00 00       	call   80104460 <release>
...
80103605:	e8 76 0c 00 00       	call   80104280 <initlock>
}
8010360a:	c9                   	leave  
8010360b:	c3                   	ret    
...
801036b4:	83 ec 04             	sub    $0x4,%esp
  pushcli();
801036b7:	e8 44 0c 00 00       	call   80104300 <pushcli>
  c = mycpu();
801036bc:	e8 4f ff ff ff       	call   80103610 <mycpu>
  p = c->proc;
801036c1:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
801036c7:	e8 74 0c 00 00       	call   80104340 <popcli>
}
...
801036f3:	e8 78 35 00 00       	call   80106c70 <setupkvm>
...
80103715:	80 
80103716:	e8 85 32 00 00       	call   801069a0 <inituvm>
  p->sz = PGSIZE;
...
80103737:	e8 74 0d 00 00       	call   801044b0 <memset>
...
8010379e:	e8 ed 0e 00 00       	call   80104690 <safestrcpy>
  p->cwd = namei("/");
...
80103819:	e8 c2 32 00 00       	call   80106ae0 <allocuvm>
...
80103827:	e8 64 30 00 00       	call   80106890 <switchuvm>
  return 0;
...
8010384a:	e8 81 33 00 00       	call   80106bd0 <deallocuvm>
...
8010388e:	e8 bd 34 00 00       	call   80106d50 <copyuvm>
...
801038f8:	e8 83 dd ff ff       	call   80101680 <idup>
...
80103956:	e8 95 e9 ff ff       	call   801022f0 <kfree>
    return -1;
...
80103975:	53                   	push   %ebx
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103976:	bb 54 2d 11 80       	mov    $0x80112d54,%ebx
{
8010397b:	83 ec 1c             	sub    $0x1c,%esp
  struct proc *curproc = myproc();
8010397e:	e8 2d fd ff ff       	call   801036b0 <myproc>
  acquire(&ptable.lock);
80103983:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
  struct proc *curproc = myproc();
8010398a:	89 c6                	mov    %eax,%esi
  acquire(&ptable.lock);
8010398c:	e8 5f 0a 00 00       	call   801043f0 <acquire>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103991:	89 da                	mov    %ebx,%edx
80103993:	eb 12                	jmp    801039a7 <waitpid+0x37>
80103995:	8d 76 00             	lea    0x0(%esi),%esi
80103998:	81 c3 84 00 00 00    	add    $0x84,%ebx
8010399e:	81 fb 54 4e 11 80    	cmp    $0x80114e54,%ebx
801039a4:	0f 43 da             	cmovae %edx,%ebx
      if(p->parent != curproc)
801039a7:	39 73 14             	cmp    %esi,0x14(%ebx)
801039aa:	75 ec                	jne    80103998 <waitpid+0x28>
      if(p->state == ZOMBIE && pid == p->pid && retrieve == 1){
801039ac:	83 7b 0c 05          	cmpl   $0x5,0xc(%ebx)
801039b0:	75 e6                	jne    80103998 <waitpid+0x28>
801039b2:	8b 7b 10             	mov    0x10(%ebx),%edi
801039b5:	3b 7d 08             	cmp    0x8(%ebp),%edi
801039b8:	75 de                	jne    80103998 <waitpid+0x28>
	kfree(p->kstack);
801039ba:	8b 53 08             	mov    0x8(%ebx),%edx
801039bd:	89 14 24             	mov    %edx,(%esp)
801039c0:	e8 2b e9 ff ff       	call   801022f0 <kfree>
	freevm(p->pgdir);
801039c5:	8b 53 04             	mov    0x4(%ebx),%edx
	p->kstack = 0;
801039c8:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
	freevm(p->pgdir);
801039cf:	89 14 24             	mov    %edx,(%esp)
801039d2:	e8 19 32 00 00       	call   80106bf0 <freevm>
	p->pid = 0;
801039d7:	c7 43 10 00 00 00 00 	movl   $0x0,0x10(%ebx)
	p->parent = 0;
801039de:	c7 43 14 00 00 00 00 	movl   $0x0,0x14(%ebx)
	p->name[0] = 0;
801039e5:	c6 43 6c 00          	movb   $0x0,0x6c(%ebx)
	p->killed = 0;
801039e9:	c7 43 24 00 00 00 00 	movl   $0x0,0x24(%ebx)
	p->state = UNUSED;
801039f0:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
	release(&ptable.lock);
801039f7:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
801039fe:	e8 5d 0a 00 00       	call   80104460 <release>
	if(status != 0) {
80103a03:	8b 45 0c             	mov    0xc(%ebp),%eax
80103a06:	85 c0                	test   %eax,%eax
80103a08:	74 08                	je     80103a12 <waitpid+0xa2>
	  *status = p->status;
80103a0a:	8b 53 7c             	mov    0x7c(%ebx),%edx
80103a0d:	8b 45 0c             	mov    0xc(%ebp),%eax
80103a10:	89 10                	mov    %edx,(%eax)
}
80103a12:	83 c4 1c             	add    $0x1c,%esp
80103a15:	89 f8                	mov    %edi,%eax
80103a17:	5b                   	pop    %ebx
80103a18:	5e                   	pop    %esi
80103a19:	5f                   	pop    %edi
80103a1a:	5d                   	pop    %ebp
...
80103a26:	83 ec 1c             	sub    $0x1c,%esp
  struct cpu *c = mycpu();
80103a29:	e8 e2 fb ff ff       	call   80103610 <mycpu>
  c->proc = 0;
80103a2e:	c7 80 ac 00 00 00 00 	movl   $0x0,0xac(%eax)
80103a35:	00 00 00 
  struct cpu *c = mycpu();
80103a38:	89 c3                	mov    %eax,%ebx
80103a3a:	8d 40 04             	lea    0x4(%eax),%eax
80103a3d:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  asm volatile("sti");
80103a40:	fb                   	sti    
    acquire(&ptable.lock);
80103a41:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103a48:	bf 54 2d 11 80       	mov    $0x80112d54,%edi
    acquire(&ptable.lock);
80103a4d:	e8 9e 09 00 00       	call   801043f0 <acquire>
80103a52:	eb 16                	jmp    80103a6a <scheduler+0x4a>
80103a54:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
      if(p->state != RUNNABLE)
80103a58:	81 c7 84 00 00 00    	add    $0x84,%edi
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103a5e:	81 ff 54 4e 11 80    	cmp    $0x80114e54,%edi
80103a64:	0f 83 df 00 00 00    	jae    80103b49 <scheduler+0x129>
      if(p->state != RUNNABLE)
80103a6a:	8b 47 0c             	mov    0xc(%edi),%eax
80103a6d:	83 f8 03             	cmp    $0x3,%eax
80103a70:	75 e6                	jne    80103a58 <scheduler+0x38>
         for(i = p+1; i < &ptable.proc[NPROC]; i++) {
80103a72:	8d b7 84 00 00 00    	lea    0x84(%edi),%esi
80103a78:	81 fe 54 4e 11 80    	cmp    $0x80114e54,%esi
80103a7e:	72 19                	jb     80103a99 <scheduler+0x79>
80103a80:	eb 3f                	jmp    80103ac1 <scheduler+0xa1>
80103a82:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
80103a88:	81 c6 84 00 00 00    	add    $0x84,%esi
80103a8e:	81 fe 54 4e 11 80    	cmp    $0x80114e54,%esi
80103a94:	73 25                	jae    80103abb <scheduler+0x9b>
80103a96:	8b 47 0c             	mov    0xc(%edi),%eax
           if(p->state == RUNNABLE && i->priority < p->priority)
80103a99:	83 f8 03             	cmp    $0x3,%eax
80103a9c:	75 ea                	jne    80103a88 <scheduler+0x68>
80103a9e:	8b 87 80 00 00 00    	mov    0x80(%edi),%eax
80103aa4:	39 86 80 00 00 00    	cmp    %eax,0x80(%esi)
80103aaa:	0f 4c fe             	cmovl  %esi,%edi
         for(i = p+1; i < &ptable.proc[NPROC]; i++) {
80103aad:	81 c6 84 00 00 00    	add    $0x84,%esi
80103ab3:	81 fe 54 4e 11 80    	cmp    $0x80114e54,%esi
80103ab9:	72 db                	jb     80103a96 <scheduler+0x76>
80103abb:	8d b7 84 00 00 00    	lea    0x84(%edi),%esi
      c->proc = p;
80103ac1:	89 bb ac 00 00 00    	mov    %edi,0xac(%ebx)
      switchuvm(p);
80103ac7:	89 3c 24             	mov    %edi,(%esp)
80103aca:	e8 c1 2d 00 00       	call   80106890 <switchuvm>
      swtch(&(c->scheduler), p->context);
80103acf:	8b 47 1c             	mov    0x1c(%edi),%eax
      p->state = RUNNING;
80103ad2:	c7 47 0c 04 00 00 00 	movl   $0x4,0xc(%edi)
      swtch(&(c->scheduler), p->context);
80103ad9:	89 44 24 04          	mov    %eax,0x4(%esp)
80103add:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80103ae0:	89 04 24             	mov    %eax,(%esp)
80103ae3:	e8 03 0c 00 00       	call   801046eb <swtch>
      switchkvm();
80103ae8:	e8 83 2d 00 00       	call   80106870 <switchkvm>
      for(i = ptable.proc; i < &ptable.proc[NPROC]; i++) {
80103aed:	b8 54 2d 11 80       	mov    $0x80112d54,%eax
80103af2:	eb 19                	jmp    80103b0d <scheduler+0xed>
80103af4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
          i->priority = i->priority - 10;
80103af8:	83 ea 0a             	sub    $0xa,%edx
80103afb:	89 90 80 00 00 00    	mov    %edx,0x80(%eax)
      for(i = ptable.proc; i < &ptable.proc[NPROC]; i++) {
80103b01:	05 84 00 00 00       	add    $0x84,%eax
80103b06:	3d 54 4e 11 80       	cmp    $0x80114e54,%eax
80103b0b:	74 24                	je     80103b31 <scheduler+0x111>
        if(i == p && i->priority == 31)
80103b0d:	39 f8                	cmp    %edi,%eax
80103b0f:	74 4f                	je     80103b60 <scheduler+0x140>
        else if(i != p && i->priority > 0) {
80103b11:	8b 90 80 00 00 00    	mov    0x80(%eax),%edx
80103b17:	85 d2                	test   %edx,%edx
80103b19:	7f dd                	jg     80103af8 <scheduler+0xd8>
          i->priority = 0;
80103b1b:	c7 80 80 00 00 00 00 	movl   $0x0,0x80(%eax)
80103b22:	00 00 00 
      for(i = ptable.proc; i < &ptable.proc[NPROC]; i++) {
80103b25:	05 84 00 00 00       	add    $0x84,%eax
80103b2a:	3d 54 4e 11 80       	cmp    $0x80114e54,%eax
80103b2f:	75 dc                	jne    80103b0d <scheduler+0xed>
      c->proc = 0;
80103b31:	89 f7                	mov    %esi,%edi
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103b33:	81 ff 54 4e 11 80    	cmp    $0x80114e54,%edi
      c->proc = 0;
80103b39:	c7 83 ac 00 00 00 00 	movl   $0x0,0xac(%ebx)
80103b40:	00 00 00 
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103b43:	0f 82 21 ff ff ff    	jb     80103a6a <scheduler+0x4a>
    release(&ptable.lock);
80103b49:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80103b50:	e8 0b 09 00 00       	call   80104460 <release>
  }
80103b55:	e9 e6 fe ff ff       	jmp    80103a40 <scheduler+0x20>
80103b5a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
        if(i == p && i->priority == 31)
80103b60:	83 b8 80 00 00 00 1f 	cmpl   $0x1f,0x80(%eax)
80103b67:	74 98                	je     80103b01 <scheduler+0xe1>
        else if(i == p && i->priority < 31) {
80103b69:	8b 90 80 00 00 00    	mov    0x80(%eax),%edx
80103b6f:	83 fa 1e             	cmp    $0x1e,%edx
80103b72:	7f a7                	jg     80103b1b <scheduler+0xfb>
          i->priority = i->priority + 10;
80103b74:	83 c2 0a             	add    $0xa,%edx
80103b77:	89 90 80 00 00 00    	mov    %edx,0x80(%eax)
80103b7d:	eb 82                	jmp    80103b01 <scheduler+0xe1>
80103b7f:	90                   	nop
...
80103b88:	e8 23 fb ff ff       	call   801036b0 <myproc>
  if(!holding(&ptable.lock))
80103b8d:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
  struct proc *p = myproc();
80103b94:	89 c3                	mov    %eax,%ebx
  if(!holding(&ptable.lock))
80103b96:	e8 15 08 00 00       	call   801043b0 <holding>
80103b9b:	85 c0                	test   %eax,%eax
80103b9d:	74 4f                	je     80103bee <sched+0x6e>
  if(mycpu()->ncli != 1)
80103b9f:	e8 6c fa ff ff       	call   80103610 <mycpu>
80103ba4:	83 b8 a4 00 00 00 01 	cmpl   $0x1,0xa4(%eax)
80103bab:	75 65                	jne    80103c12 <sched+0x92>
  if(p->state == RUNNING)
80103bad:	83 7b 0c 04          	cmpl   $0x4,0xc(%ebx)
80103bb1:	74 53                	je     80103c06 <sched+0x86>
  asm volatile("pushfl; popl %0" : "=r" (eflags));
80103bb3:	9c                   	pushf  
80103bb4:	58                   	pop    %eax
  if(readeflags()&FL_IF)
80103bb5:	f6 c4 02             	test   $0x2,%ah
80103bb8:	75 40                	jne    80103bfa <sched+0x7a>
  intena = mycpu()->intena;
80103bba:	e8 51 fa ff ff       	call   80103610 <mycpu>
  swtch(&p->context, mycpu()->scheduler);
80103bbf:	83 c3 1c             	add    $0x1c,%ebx
  intena = mycpu()->intena;
80103bc2:	8b b0 a8 00 00 00    	mov    0xa8(%eax),%esi
  swtch(&p->context, mycpu()->scheduler);
80103bc8:	e8 43 fa ff ff       	call   80103610 <mycpu>
80103bcd:	8b 40 04             	mov    0x4(%eax),%eax
80103bd0:	89 1c 24             	mov    %ebx,(%esp)
80103bd3:	89 44 24 04          	mov    %eax,0x4(%esp)
80103bd7:	e8 0f 0b 00 00       	call   801046eb <swtch>
  mycpu()->intena = intena;
80103bdc:	e8 2f fa ff ff       	call   80103610 <mycpu>
80103be1:	89 b0 a8 00 00 00    	mov    %esi,0xa8(%eax)
}
...
80103bee:	c7 04 24 b0 74 10 80 	movl   $0x801074b0,(%esp)
80103bf5:	e8 66 c7 ff ff       	call   80100360 <panic>
    panic("sched interruptible");
80103bfa:	c7 04 24 dc 74 10 80 	movl   $0x801074dc,(%esp)
80103c01:	e8 5a c7 ff ff       	call   80100360 <panic>
    panic("sched running");
80103c06:	c7 04 24 ce 74 10 80 	movl   $0x801074ce,(%esp)
80103c0d:	e8 4e c7 ff ff       	call   80100360 <panic>
    panic("sched locks");
80103c12:	c7 04 24 c2 74 10 80 	movl   $0x801074c2,(%esp)
...
80103c27:	83 ec 10             	sub    $0x10,%esp
  struct proc *curproc = myproc();
80103c2a:	e8 81 fa ff ff       	call   801036b0 <myproc>
  if(curproc == initproc)
80103c2f:	3b 05 b8 a5 10 80    	cmp    0x8010a5b8,%eax
  struct proc *curproc = myproc();
80103c35:	89 c3                	mov    %eax,%ebx
  if(curproc == initproc)
80103c37:	0f 84 fd 00 00 00    	je     80103d3a <exit+0x11a>
80103c3d:	8d 76 00             	lea    0x0(%esi),%esi
    if(curproc->ofile[fd]){
80103c40:	8b 44 b3 28          	mov    0x28(%ebx,%esi,4),%eax
80103c44:	85 c0                	test   %eax,%eax
80103c46:	74 10                	je     80103c58 <exit+0x38>
      fileclose(curproc->ofile[fd]);
80103c48:	89 04 24             	mov    %eax,(%esp)
80103c4b:	e8 e0 d1 ff ff       	call   80100e30 <fileclose>
      curproc->ofile[fd] = 0;
80103c50:	c7 44 b3 28 00 00 00 	movl   $0x0,0x28(%ebx,%esi,4)
80103c57:	00 
  for(fd = 0; fd < NOFILE; fd++){
80103c58:	83 c6 01             	add    $0x1,%esi
80103c5b:	83 fe 10             	cmp    $0x10,%esi
80103c5e:	75 e0                	jne    80103c40 <exit+0x20>
  begin_op();
80103c60:	e8 ab ee ff ff       	call   80102b10 <begin_op>
  iput(curproc->cwd);
80103c65:	8b 43 68             	mov    0x68(%ebx),%eax
80103c68:	89 04 24             	mov    %eax,(%esp)
80103c6b:	e8 60 db ff ff       	call   801017d0 <iput>
  end_op();
80103c70:	e8 0b ef ff ff       	call   80102b80 <end_op>
  curproc->cwd = 0;
80103c75:	c7 43 68 00 00 00 00 	movl   $0x0,0x68(%ebx)
  acquire(&ptable.lock);
80103c7c:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80103c83:	e8 68 07 00 00       	call   801043f0 <acquire>
  wakeup1(curproc->parent);
80103c88:	8b 43 14             	mov    0x14(%ebx),%eax
static void
wakeup1(void *chan)
{
  struct proc *p;
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103c8b:	ba 54 2d 11 80       	mov    $0x80112d54,%edx
80103c90:	eb 14                	jmp    80103ca6 <exit+0x86>
80103c92:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
80103c98:	81 c2 84 00 00 00    	add    $0x84,%edx
80103c9e:	81 fa 54 4e 11 80    	cmp    $0x80114e54,%edx
80103ca4:	74 20                	je     80103cc6 <exit+0xa6>
    if(p->state == SLEEPING && p->chan == chan)
80103ca6:	83 7a 0c 02          	cmpl   $0x2,0xc(%edx)
80103caa:	75 ec                	jne    80103c98 <exit+0x78>
80103cac:	3b 42 20             	cmp    0x20(%edx),%eax
80103caf:	75 e7                	jne    80103c98 <exit+0x78>
      p->state = RUNNABLE;
80103cb1:	c7 42 0c 03 00 00 00 	movl   $0x3,0xc(%edx)
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103cb8:	81 c2 84 00 00 00    	add    $0x84,%edx
80103cbe:	81 fa 54 4e 11 80    	cmp    $0x80114e54,%edx
80103cc4:	75 e0                	jne    80103ca6 <exit+0x86>
  curproc->status = status;
80103cc6:	8b 45 08             	mov    0x8(%ebp),%eax
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103cc9:	b9 54 2d 11 80       	mov    $0x80112d54,%ecx
  curproc->status = status;
80103cce:	89 43 7c             	mov    %eax,0x7c(%ebx)
      p->parent = initproc;
80103cd1:	a1 b8 a5 10 80       	mov    0x8010a5b8,%eax
80103cd6:	eb 0e                	jmp    80103ce6 <exit+0xc6>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103cd8:	81 c1 84 00 00 00    	add    $0x84,%ecx
80103cde:	81 f9 54 4e 11 80    	cmp    $0x80114e54,%ecx
80103ce4:	74 3c                	je     80103d22 <exit+0x102>
    if(p->parent == curproc){
80103ce6:	39 59 14             	cmp    %ebx,0x14(%ecx)
80103ce9:	75 ed                	jne    80103cd8 <exit+0xb8>
      if(p->state == ZOMBIE)
80103ceb:	83 79 0c 05          	cmpl   $0x5,0xc(%ecx)
      p->parent = initproc;
80103cef:	89 41 14             	mov    %eax,0x14(%ecx)
      if(p->state == ZOMBIE)
80103cf2:	75 e4                	jne    80103cd8 <exit+0xb8>
80103cf4:	ba 54 2d 11 80       	mov    $0x80112d54,%edx
80103cf9:	eb 13                	jmp    80103d0e <exit+0xee>
80103cfb:	90                   	nop
80103cfc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103d00:	81 c2 84 00 00 00    	add    $0x84,%edx
80103d06:	81 fa 54 4e 11 80    	cmp    $0x80114e54,%edx
80103d0c:	74 ca                	je     80103cd8 <exit+0xb8>
    if(p->state == SLEEPING && p->chan == chan)
80103d0e:	83 7a 0c 02          	cmpl   $0x2,0xc(%edx)
80103d12:	75 ec                	jne    80103d00 <exit+0xe0>
80103d14:	3b 42 20             	cmp    0x20(%edx),%eax
80103d17:	75 e7                	jne    80103d00 <exit+0xe0>
      p->state = RUNNABLE;
80103d19:	c7 42 0c 03 00 00 00 	movl   $0x3,0xc(%edx)
80103d20:	eb de                	jmp    80103d00 <exit+0xe0>
  curproc->state = ZOMBIE;
80103d22:	c7 43 0c 05 00 00 00 	movl   $0x5,0xc(%ebx)
  sched();
80103d29:	e8 52 fe ff ff       	call   80103b80 <sched>
  panic("zombie exit");
80103d2e:	c7 04 24 fd 74 10 80 	movl   $0x801074fd,(%esp)
80103d35:	e8 26 c6 ff ff       	call   80100360 <panic>
    panic("init exiting");
80103d3a:	c7 04 24 f0 74 10 80 	movl   $0x801074f0,(%esp)
...
80103d56:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80103d5d:	e8 8e 06 00 00       	call   801043f0 <acquire>
  myproc()->state = RUNNABLE;
80103d62:	e8 49 f9 ff ff       	call   801036b0 <myproc>
80103d67:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  sched();
80103d6e:	e8 0d fe ff ff       	call   80103b80 <sched>
  release(&ptable.lock);
80103d73:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80103d7a:	e8 e1 06 00 00       	call   80104460 <release>
}
80103d7f:	c9                   	leave  
80103d80:	c3                   	ret    
80103d81:	eb 0d                	jmp    80103d90 <setpriority>
80103d83:	90                   	nop
80103d84:	90                   	nop
80103d85:	90                   	nop
80103d86:	90                   	nop
...
80103d94:	83 ec 14             	sub    $0x14,%esp
  acquire(&ptable.lock);
80103d97:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80103d9e:	e8 4d 06 00 00       	call   801043f0 <acquire>
  struct proc *curproc = myproc();
80103da3:	e8 08 f9 ff ff       	call   801036b0 <myproc>
  curproc->priority = priority;
80103da8:	8b 55 08             	mov    0x8(%ebp),%edx
  int previous_p = curproc->priority;
80103dab:	8b 98 80 00 00 00    	mov    0x80(%eax),%ebx
  curproc->priority = priority;
80103db1:	89 90 80 00 00 00    	mov    %edx,0x80(%eax)
  release(&ptable.lock);
80103db7:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80103dbe:	e8 9d 06 00 00       	call   80104460 <release>
  yield();
80103dc3:	e8 88 ff ff ff       	call   80103d50 <yield>
}
80103dc8:	83 c4 14             	add    $0x14,%esp
...
80103ddc:	8b 75 0c             	mov    0xc(%ebp),%esi
  struct proc *p = myproc();
80103ddf:	e8 cc f8 ff ff       	call   801036b0 <myproc>
  if(p == 0)
80103de4:	85 c0                	test   %eax,%eax
  struct proc *p = myproc();
80103de6:	89 c3                	mov    %eax,%ebx
  if(p == 0)
80103de8:	0f 84 7c 00 00 00    	je     80103e6a <sleep+0x9a>
  if(lk == 0)
80103dee:	85 f6                	test   %esi,%esi
80103df0:	74 6c                	je     80103e5e <sleep+0x8e>
  if(lk != &ptable.lock){  //DOC: sleeplock0
80103df2:	81 fe 20 2d 11 80    	cmp    $0x80112d20,%esi
80103df8:	74 46                	je     80103e40 <sleep+0x70>
    acquire(&ptable.lock);  //DOC: sleeplock1
80103dfa:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80103e01:	e8 ea 05 00 00       	call   801043f0 <acquire>
    release(lk);
80103e06:	89 34 24             	mov    %esi,(%esp)
80103e09:	e8 52 06 00 00       	call   80104460 <release>
  p->chan = chan;
80103e0e:	89 7b 20             	mov    %edi,0x20(%ebx)
  p->state = SLEEPING;
80103e11:	c7 43 0c 02 00 00 00 	movl   $0x2,0xc(%ebx)
  sched();
80103e18:	e8 63 fd ff ff       	call   80103b80 <sched>
  p->chan = 0;
80103e1d:	c7 43 20 00 00 00 00 	movl   $0x0,0x20(%ebx)
    release(&ptable.lock);
80103e24:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80103e2b:	e8 30 06 00 00       	call   80104460 <release>
    acquire(lk);
80103e30:	89 75 08             	mov    %esi,0x8(%ebp)
}
80103e33:	83 c4 1c             	add    $0x1c,%esp
80103e36:	5b                   	pop    %ebx
80103e37:	5e                   	pop    %esi
80103e38:	5f                   	pop    %edi
80103e39:	5d                   	pop    %ebp
    acquire(lk);
80103e3a:	e9 b1 05 00 00       	jmp    801043f0 <acquire>
80103e3f:	90                   	nop
  p->chan = chan;
80103e40:	89 78 20             	mov    %edi,0x20(%eax)
  p->state = SLEEPING;
80103e43:	c7 40 0c 02 00 00 00 	movl   $0x2,0xc(%eax)
  sched();
80103e4a:	e8 31 fd ff ff       	call   80103b80 <sched>
  p->chan = 0;
80103e4f:	c7 43 20 00 00 00 00 	movl   $0x0,0x20(%ebx)
}
80103e56:	83 c4 1c             	add    $0x1c,%esp
80103e59:	5b                   	pop    %ebx
80103e5a:	5e                   	pop    %esi
80103e5b:	5f                   	pop    %edi
80103e5c:	5d                   	pop    %ebp
...
80103e5e:	c7 04 24 0f 75 10 80 	movl   $0x8010750f,(%esp)
80103e65:	e8 f6 c4 ff ff       	call   80100360 <panic>
    panic("sleep");
80103e6a:	c7 04 24 09 75 10 80 	movl   $0x80107509,(%esp)
80103e71:	e8 ea c4 ff ff       	call   80100360 <panic>
...
80103e89:	8b 7d 08             	mov    0x8(%ebp),%edi
  struct proc *curproc = myproc();
80103e8c:	e8 1f f8 ff ff       	call   801036b0 <myproc>
  acquire(&ptable.lock);
80103e91:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
  struct proc *curproc = myproc();
80103e98:	89 c6                	mov    %eax,%esi
  acquire(&ptable.lock);
80103e9a:	e8 51 05 00 00       	call   801043f0 <acquire>
    havekids = 0;
80103e9f:	31 c0                	xor    %eax,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103ea1:	bb 54 2d 11 80       	mov    $0x80112d54,%ebx
80103ea6:	eb 0e                	jmp    80103eb6 <wait+0x36>
80103ea8:	81 c3 84 00 00 00    	add    $0x84,%ebx
80103eae:	81 fb 54 4e 11 80    	cmp    $0x80114e54,%ebx
80103eb4:	74 22                	je     80103ed8 <wait+0x58>
      if(p->parent != curproc)
80103eb6:	39 73 14             	cmp    %esi,0x14(%ebx)
80103eb9:	75 ed                	jne    80103ea8 <wait+0x28>
      if(p->state == ZOMBIE){
80103ebb:	83 7b 0c 05          	cmpl   $0x5,0xc(%ebx)
80103ebf:	74 38                	je     80103ef9 <wait+0x79>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103ec1:	81 c3 84 00 00 00    	add    $0x84,%ebx
      havekids = 1;
80103ec7:	b8 01 00 00 00       	mov    $0x1,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103ecc:	81 fb 54 4e 11 80    	cmp    $0x80114e54,%ebx
80103ed2:	75 e2                	jne    80103eb6 <wait+0x36>
80103ed4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    if(!havekids || curproc->killed){
80103ed8:	85 c0                	test   %eax,%eax
80103eda:	0f 84 82 00 00 00    	je     80103f62 <wait+0xe2>
80103ee0:	8b 46 24             	mov    0x24(%esi),%eax
80103ee3:	85 c0                	test   %eax,%eax
80103ee5:	75 7b                	jne    80103f62 <wait+0xe2>
    sleep(curproc, &ptable.lock);  //DOC: wait-sleep
80103ee7:	c7 44 24 04 20 2d 11 	movl   $0x80112d20,0x4(%esp)
80103eee:	80 
80103eef:	89 34 24             	mov    %esi,(%esp)
80103ef2:	e8 d9 fe ff ff       	call   80103dd0 <sleep>
    }
80103ef7:	eb a6                	jmp    80103e9f <wait+0x1f>
        kfree(p->kstack);
80103ef9:	8b 43 08             	mov    0x8(%ebx),%eax
        pid = p->pid;
80103efc:	8b 73 10             	mov    0x10(%ebx),%esi
        kfree(p->kstack);
80103eff:	89 04 24             	mov    %eax,(%esp)
80103f02:	e8 e9 e3 ff ff       	call   801022f0 <kfree>
	freevm(p->pgdir);
80103f07:	8b 43 04             	mov    0x4(%ebx),%eax
        p->kstack = 0;
80103f0a:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
	freevm(p->pgdir);
80103f11:	89 04 24             	mov    %eax,(%esp)
80103f14:	e8 d7 2c 00 00       	call   80106bf0 <freevm>
        release(&ptable.lock);
80103f19:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
        p->pid = 0;
80103f20:	c7 43 10 00 00 00 00 	movl   $0x0,0x10(%ebx)
        p->parent = 0;
80103f27:	c7 43 14 00 00 00 00 	movl   $0x0,0x14(%ebx)
        p->name[0] = 0;
80103f2e:	c6 43 6c 00          	movb   $0x0,0x6c(%ebx)
        p->killed = 0;
80103f32:	c7 43 24 00 00 00 00 	movl   $0x0,0x24(%ebx)
        p->state = UNUSED;
80103f39:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        p->priority = 30;
80103f40:	c7 83 80 00 00 00 1e 	movl   $0x1e,0x80(%ebx)
80103f47:	00 00 00 
        release(&ptable.lock);
80103f4a:	e8 11 05 00 00       	call   80104460 <release>
        if(status != 0){
80103f4f:	85 ff                	test   %edi,%edi
80103f51:	74 28                	je     80103f7b <wait+0xfb>
          *status = p->status;
80103f53:	8b 43 7c             	mov    0x7c(%ebx),%eax
80103f56:	89 07                	mov    %eax,(%edi)
}
80103f58:	83 c4 1c             	add    $0x1c,%esp
	return pid;
80103f5b:	89 f0                	mov    %esi,%eax
}
80103f5d:	5b                   	pop    %ebx
80103f5e:	5e                   	pop    %esi
80103f5f:	5f                   	pop    %edi
...
80103f69:	e8 f2 04 00 00       	call   80104460 <release>
}
80103f6e:	83 c4 1c             	add    $0x1c,%esp
      return -1;
...
80103f79:	5d                   	pop    %ebp
80103f7a:	c3                   	ret    
80103f7b:	83 c4 1c             	add    $0x1c,%esp
	return pid;
...
80103fc7:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103fce:	05 84 00 00 00       	add    $0x84,%eax
80103fd3:	3d 54 4e 11 80       	cmp    $0x80114e54,%eax
80103fd8:	75 e2                	jne    80103fbc <wakeup+0x2c>
80103fda:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  wakeup1(chan);
  release(&ptable.lock);
80103fe0:	c7 45 08 20 2d 11 80 	movl   $0x80112d20,0x8(%ebp)
}
80103fe7:	83 c4 14             	add    $0x14,%esp
80103fea:	5b                   	pop    %ebx
80103feb:	5d                   	pop    %ebp
  release(&ptable.lock);
80103fec:	e9 6f 04 00 00       	jmp    80104460 <release>
80103ff1:	eb 0d                	jmp    80104000 <kill>
80103ff3:	90                   	nop
80103ff4:	90                   	nop
80103ff5:	90                   	nop
80103ff6:	90                   	nop
...
8010401b:	eb 0f                	jmp    8010402c <kill+0x2c>
...
80104045:	e8 16 04 00 00       	call   80104460 <release>
      return 0;
    }
  }
  release(&ptable.lock);
...
8010404a:	83 c4 14             	add    $0x14,%esp
      return 0;
...
8010406f:	e8 ec 03 00 00       	call   80104460 <release>
}
80104074:	83 c4 14             	add    $0x14,%esp
  return -1;
...
80104091:	eb 23                	jmp    801040b6 <procdump+0x36>
80104093:	90                   	nop
80104094:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ...
    cprintf("\n");
80104098:	c7 04 24 9f 78 10 80 	movl   $0x8010789f,(%esp)
8010409f:	e8 ac c5 ff ff       	call   80100650 <cprintf>
801040a4:	81 c3 84 00 00 00    	add    $0x84,%ebx
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801040aa:	81 fb c0 4e 11 80    	cmp    $0x80114ec0,%ebx
801040b0:	0f 84 8a 00 00 00    	je     80104140 <procdump+0xc0>
    if(p->state == UNUSED)
801040b6:	8b 43 a0             	mov    -0x60(%ebx),%eax
801040b9:	85 c0                	test   %eax,%eax
801040bb:	74 e7                	je     801040a4 <procdump+0x24>
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
801040bd:	83 f8 05             	cmp    $0x5,%eax
      state = "???";
801040c0:	ba 20 75 10 80       	mov    $0x80107520,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
801040c5:	77 11                	ja     801040d8 <procdump+0x58>
801040c7:	8b 14 85 80 75 10 80 	mov    -0x7fef8a80(,%eax,4),%edx
      state = "???";
801040ce:	b8 20 75 10 80       	mov    $0x80107520,%eax
801040d3:	85 d2                	test   %edx,%edx
801040d5:	0f 44 d0             	cmove  %eax,%edx
    cprintf("%d %s %s", p->pid, state, p->name);
801040d8:	8b 43 a4             	mov    -0x5c(%ebx),%eax
801040db:	89 5c 24 0c          	mov    %ebx,0xc(%esp)
801040df:	89 54 24 08          	mov    %edx,0x8(%esp)
801040e3:	c7 04 24 24 75 10 80 	movl   $0x80107524,(%esp)
801040ea:	89 44 24 04          	mov    %eax,0x4(%esp)
801040ee:	e8 5d c5 ff ff       	call   80100650 <cprintf>
    if(p->state == SLEEPING){
801040f3:	83 7b a0 02          	cmpl   $0x2,-0x60(%ebx)
801040f7:	75 9f                	jne    80104098 <procdump+0x18>
      getcallerpcs((uint*)p->context->ebp+2, pc);
801040f9:	8d 45 c0             	lea    -0x40(%ebp),%eax
801040fc:	89 44 24 04          	mov    %eax,0x4(%esp)
80104100:	8b 43 b0             	mov    -0x50(%ebx),%eax
80104103:	8d 7d c0             	lea    -0x40(%ebp),%edi
80104106:	8b 40 0c             	mov    0xc(%eax),%eax
80104109:	83 c0 08             	add    $0x8,%eax
8010410c:	89 04 24             	mov    %eax,(%esp)
8010410f:	e8 8c 01 00 00       	call   801042a0 <getcallerpcs>
...
80104129:	c7 04 24 61 6f 10 80 	movl   $0x80106f61,(%esp)
...
8010415a:	c7 44 24 04 98 75 10 	movl   $0x80107598,0x4(%esp)
80104161:	80 
...
801041b7:	e8 14 fc ff ff       	call   80103dd0 <sleep>
  while (lk->locked) {
...
801041c2:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
  lk->pid = myproc()->pid;
801041c8:	e8 e3 f4 ff ff       	call   801036b0 <myproc>
...
80104216:	e8 75 fd ff ff       	call   80103f90 <wakeup>
  release(&lk->lk);
...
80104252:	e8 59 f4 ff ff       	call   801036b0 <myproc>
...
8010434b:	75 49                	jne    80104396 <popcli+0x56>
  ...
  if(--mycpu()->ncli < 0)
8010434d:	e8 be f2 ff ff       	call   80103610 <mycpu>
...
80104365:	e8 a6 f2 ff ff       	call   80103610 <mycpu>
...
80104376:	66 90                	xchg   %ax,%ax
  if(mycpu()->ncli == 0 && mycpu()->intena)
80104378:	e8 93 f2 ff ff       	call   80103610 <mycpu>
...
80104389:	c3                   	ret    
    panic("popcli");
8010438a:	c7 04 24 ba 75 10 80 	movl   $0x801075ba,(%esp)
80104391:	e8 ca bf ff ff       	call   80100360 <panic>
    panic("popcli - interruptible");
80104396:	c7 04 24 a3 75 10 80 	movl   $0x801075a3,(%esp)
...
801043c8:	e8 43 f2 ff ff       	call   80103610 <mycpu>
...
80104422:	e8 e9 f1 ff ff       	call   80103610 <mycpu>
...
80104444:	c3                   	ret    
    panic("acquire");
80104445:	c7 04 24 c1 75 10 80 	movl   $0x801075c1,(%esp)
...
80104492:	e9 a9 fe ff ff       	jmp    80104340 <popcli>
    panic("release");
80104497:	c7 04 24 c9 75 10 80 	movl   $0x801075c9,(%esp)
...
80104707:	8b 5d 08             	mov    0x8(%ebp),%ebx
  struct proc *curproc = myproc();
8010470a:	e8 a1 ef ff ff       	call   801036b0 <myproc>
...
80104747:	8b 5d 08             	mov    0x8(%ebp),%ebx
  char *s, *ep;
  struct proc *curproc = myproc();
8010474a:	e8 61 ef ff ff       	call   801036b0 <myproc>
...
801047ab:	e8 00 ef ff ff       	call   801036b0 <myproc>
...
801047d8:	8b 5d 10             	mov    0x10(%ebp),%ebx
  int i;
  struct proc *curproc = myproc();
801047db:	e8 d0 ee ff ff       	call   801036b0 <myproc>
...
80104875:	83 ec 10             	sub    $0x10,%esp
  int num;
  struct proc *curproc = myproc();
80104878:	e8 33 ee ff ff       	call   801036b0 <myproc>
...
8010488d:	8b 14 85 00 76 10 80 	mov    -0x7fef8a00(,%eax,4),%edx
...
801048b6:	c7 04 24 d1 75 10 80 	movl   $0x801075d1,(%esp)
...
801048e6:	83 ec 04             	sub    $0x4,%esp
  int fd;
  struct proc *curproc = myproc();
801048e9:	e8 c2 ed ff ff       	call   801036b0 <myproc>
...
80104a40:	c7 44 24 04 7c 76 10 	movl   $0x8010767c,0x4(%esp)
80104a47:	80 
...
80104a5b:	c7 44 24 04 7b 76 10 	movl   $0x8010767b,0x4(%esp)
80104a62:	80 
...
80104a71:	79 89                	jns    801049fc <create+0xdc>
      panic("create dots");
80104a73:	c7 04 24 6f 76 10 80 	movl   $0x8010766f,(%esp)
80104a7a:	e8 e1 b8 ff ff       	call   80100360 <panic>
    panic("create: dirlink");
80104a7f:	c7 04 24 7e 76 10 80 	movl   $0x8010767e,(%esp)
80104a86:	e8 d5 b8 ff ff       	call   80100360 <panic>
    panic("create: ialloc");
80104a8b:	c7 04 24 60 76 10 80 	movl   $0x80107660,(%esp)
...
80104ac9:	e8 e2 eb ff ff       	call   801036b0 <myproc>
...
80104c43:	78 23                	js     80104c68 <sys_close+0x38>
  myproc()->ofile[fd] = 0;
80104c45:	e8 66 ea ff ff       	call   801036b0 <myproc>
...
80104e31:	c7 44 24 04 7c 76 10 	movl   $0x8010767c,0x4(%esp)
80104e38:	80 
...
80104e49:	c7 44 24 04 7b 76 10 	movl   $0x8010767b,0x4(%esp)
80104e50:	80 
...
80104f9d:	c7 04 24 a0 76 10 80 	movl   $0x801076a0,(%esp)
80104fa4:	e8 b7 b3 ff ff       	call   80100360 <panic>
    panic("unlink: writei");
80104fa9:	c7 04 24 b2 76 10 80 	movl   $0x801076b2,(%esp)
80104fb0:	e8 ab b3 ff ff       	call   80100360 <panic>
    panic("unlink: nlink < 1");
80104fb5:	c7 04 24 8e 76 10 80 	movl   $0x8010768e,(%esp)
...
80105205:	83 ec 20             	sub    $0x20,%esp
  ...
  struct inode *ip;
  struct proc *curproc = myproc();
80105208:	e8 a3 e4 ff ff       	call   801036b0 <myproc>
...
801053e9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
      myproc()->ofile[fd0] = 0;
801053f0:	e8 bb e2 ff ff       	call   801036b0 <myproc>
...
80105423:	5d                   	pop    %ebp
  return fork();
80105424:	e9 37 e4 ff ff       	jmp    80103860 <fork>
...
80105444:	e8 57 f3 ff ff       	call   801047a0 <argint>
80105449:	85 c0                	test   %eax,%eax
8010544b:	78 13                	js     80105460 <sys_exit+0x30>
    return -1;
  exit(status);  
8010544d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105450:	89 04 24             	mov    %eax,(%esp)
80105453:	e8 c8 e7 ff ff       	call   80103c20 <exit>
...
80105479:	c7 44 24 08 04 00 00 	movl   $0x4,0x8(%esp)
80105480:	00 
80105481:	89 44 24 04          	mov    %eax,0x4(%esp)
80105485:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
8010548c:	e8 3f f3 ff ff       	call   801047d0 <argptr>
80105491:	85 c0                	test   %eax,%eax
80105493:	78 13                	js     801054a8 <sys_wait+0x38>
    return -1;
  return wait((int*)status);
80105495:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105498:	89 04 24             	mov    %eax,(%esp)
8010549b:	e8 e0 e9 ff ff       	call   80103e80 <wait>
}
801054a0:	c9                   	leave  
801054a1:	c3                   	ret    
...
801054b3:	83 ec 28             	sub    $0x28,%esp
  int pid;
  char *status;
  int options;
  if(argint(0, &pid) < 0)
801054b6:	8d 45 ec             	lea    -0x14(%ebp),%eax
801054b9:	89 44 24 04          	mov    %eax,0x4(%esp)
801054bd:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801054c4:	e8 d7 f2 ff ff       	call   801047a0 <argint>
801054c9:	85 c0                	test   %eax,%eax
801054cb:	78 53                	js     80105520 <sys_waitpid+0x70>
    return -1;
  if(argptr(1, &status, sizeof(int)) < 0)
801054cd:	8d 45 f0             	lea    -0x10(%ebp),%eax
801054d0:	c7 44 24 08 04 00 00 	movl   $0x4,0x8(%esp)
801054d7:	00 
801054d8:	89 44 24 04          	mov    %eax,0x4(%esp)
801054dc:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
801054e3:	e8 e8 f2 ff ff       	call   801047d0 <argptr>
801054e8:	85 c0                	test   %eax,%eax
801054ea:	78 34                	js     80105520 <sys_waitpid+0x70>
    return -1;
  if(argint(2, &options) < 0) 
801054ec:	8d 45 f4             	lea    -0xc(%ebp),%eax
801054ef:	89 44 24 04          	mov    %eax,0x4(%esp)
801054f3:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
801054fa:	e8 a1 f2 ff ff       	call   801047a0 <argint>
801054ff:	85 c0                	test   %eax,%eax
80105501:	78 1d                	js     80105520 <sys_waitpid+0x70>
    return -1;
  return waitpid(pid,(int*)status, options);
80105503:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105506:	89 44 24 08          	mov    %eax,0x8(%esp)
8010550a:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010550d:	89 44 24 04          	mov    %eax,0x4(%esp)
80105511:	8b 45 ec             	mov    -0x14(%ebp),%eax
80105514:	89 04 24             	mov    %eax,(%esp)
80105517:	e8 54 e4 ff ff       	call   80103970 <waitpid>
}
8010551c:	c9                   	leave  
8010551d:	c3                   	ret    
...
80105544:	e8 57 f2 ff ff       	call   801047a0 <argint>
  return setpriority(p);
80105549:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010554c:	89 04 24             	mov    %eax,(%esp)
8010554f:	e8 3c e8 ff ff       	call   80103d90 <setpriority>
}
80105554:	c9                   	leave  
80105555:	c3                   	ret    
...
80105574:	e8 27 f2 ff ff       	call   801047a0 <argint>
...
80105583:	e8 78 ea ff ff       	call   80104000 <kill>
}
80105588:	c9                   	leave  
80105589:	c3                   	ret    
...
801055a3:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
801055a6:	e8 05 e1 ff ff       	call   801036b0 <myproc>
...
801055c5:	e8 d6 f1 ff ff       	call   801047a0 <argint>
801055ca:	85 c0                	test   %eax,%eax
801055cc:	78 22                	js     801055f0 <sys_sbrk+0x40>
    return -1;
  addr = myproc()->sz;
801055ce:	e8 dd e0 ff ff       	call   801036b0 <myproc>
  if(growproc(n) < 0)
...
801055db:	e8 10 e2 ff ff       	call   801037f0 <growproc>
...
80105640:	c7 44 24 04 60 4e 11 	movl   $0x80114e60,0x4(%esp)
80105647:	80 
80105648:	c7 04 24 a0 56 11 80 	movl   $0x801156a0,(%esp)
8010564f:	e8 7c e7 ff ff       	call   80103dd0 <sleep>
  while(ticks - ticks0 < n){
80105654:	a1 a0 56 11 80       	mov    0x801156a0,%eax
...
8010566a:	74 d4                	je     80105640 <sys_sleep+0x40>
      release(&tickslock);
8010566c:	c7 04 24 60 4e 11 80 	movl   $0x80114e60,(%esp)
80105673:	e8 e8 ed ff ff       	call   80104460 <release>
      return -1;
...
80105684:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  release(&tickslock);
80105688:	c7 04 24 60 4e 11 80 	movl   $0x80114e60,(%esp)
8010568f:	e8 cc ed ff ff       	call   80104460 <release>
}
...
80105759:	c7 44 24 04 c1 76 10 	movl   $0x801076c1,0x4(%esp)
80105760:	80 
...
80105786:	66 a3 a6 50 11 80    	mov    %ax,0x801150a6
  initlock(&tickslock, "time");
8010578c:	e8 ef ea ff ff       	call   80104280 <initlock>
}
80105791:	c9                   	leave  
80105792:	c3                   	ret    
...
801057f0:	ff 24 85 68 77 10 80 	jmp    *-0x7fef8898(,%eax,4)
801057f7:	90                   	nop
    lapiceoi();
    break;
...
801057f8:	e8 b3 de ff ff       	call   801036b0 <myproc>
...
8010581c:	e8 6f de ff ff       	call   80103690 <cpuid>
...
80105834:	e8 77 de ff ff       	call   801036b0 <myproc>
    cprintf("pid %d %s: trap %d err %d on cpu %d "
...
80105863:	c7 04 24 24 77 10 80 	movl   $0x80107724,(%esp)
8010586a:	89 44 24 04          	mov    %eax,0x4(%esp)
8010586e:	e8 dd ad ff ff       	call   80100650 <cprintf>
            tf->err, cpuid(), tf->eip, rcr2());
    myproc()->killed = 1;
80105873:	e8 38 de ff ff       	call   801036b0 <myproc>
...
80105880:	e8 2b de ff ff       	call   801036b0 <myproc>
80105885:	85 c0                	test   %eax,%eax
80105887:	74 0c                	je     80105895 <trap+0xc5>
80105889:	e8 22 de ff ff       	call   801036b0 <myproc>
...
80105895:	e8 16 de ff ff       	call   801036b0 <myproc>
...
801058a9:	74 55                	je     80105900 <trap+0x130>
  ...
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
801058ab:	e8 00 de ff ff       	call   801036b0 <myproc>
801058b0:	85 c0                	test   %eax,%eax
801058b2:	74 1d                	je     801058d1 <trap+0x101>
801058b4:	e8 f7 dd ff ff       	call   801036b0 <myproc>
...
801058f4:	e8 27 e3 ff ff       	call   80103c20 <exit>
...
80105904:	75 a5                	jne    801058ab <trap+0xdb>
    yield();
80105906:	e8 45 e4 ff ff       	call   80103d50 <yield>
8010590b:	eb 9e                	jmp    801058ab <trap+0xdb>
8010590d:	8d 76 00             	lea    0x0(%esi),%esi
    if(cpuid() == 0){
80105910:	e8 7b dd ff ff       	call   80103690 <cpuid>
...
80105957:	e8 34 dd ff ff       	call   80103690 <cpuid>
8010595c:	c7 04 24 cc 76 10 80 	movl   $0x801076cc,(%esp)
...
80105989:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    if(myproc()->killed)
80105990:	e8 1b dd ff ff       	call   801036b0 <myproc>
80105995:	8b 70 24             	mov    0x24(%eax),%esi
80105998:	85 f6                	test   %esi,%esi
8010599a:	75 34                	jne    801059d0 <trap+0x200>
    myproc()->tf = tf;
8010599c:	e8 0f dd ff ff       	call   801036b0 <myproc>
801059a1:	89 58 18             	mov    %ebx,0x18(%eax)
    syscall();
801059a4:	e8 c7 ee ff ff       	call   80104870 <syscall>
    if(myproc()->killed)
801059a9:	e8 02 dd ff ff       	call   801036b0 <myproc>
...
80105a2a:	c7 04 24 f0 76 10 80 	movl   $0x801076f0,(%esp)
80105a31:	89 44 24 04          	mov    %eax,0x4(%esp)
80105a35:	e8 16 ac ff ff       	call   80100650 <cprintf>
      panic("trap");
80105a3a:	c7 04 24 c6 76 10 80 	movl   $0x801076c6,(%esp)
...
80105b37:	00 
  for(p="xv6...\n"; *p; p++)
80105b38:	bb e8 77 10 80       	mov    $0x801077e8,%ebx
  ioapicenable(IRQ_COM1, 0);
...
80106662:	e8 49 de ff ff       	call   801044b0 <memset>
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
...
80106701:	c3                   	ret    
      panic("remap");
80106702:	c7 04 24 f0 77 10 80 	movl   $0x801077f0,(%esp)
...
801067b3:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
801067b6:	e8 d5 ce ff ff       	call   80103690 <cpuid>
...
801068b4:	0f 84 c3 00 00 00    	je     8010697d <switchuvm+0xed>
  pushcli();
801068ba:	e8 41 da ff ff       	call   80104300 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
801068bf:	e8 4c cd ff ff       	call   80103610 <mycpu>
801068c4:	89 c3                	mov    %eax,%ebx
801068c6:	e8 45 cd ff ff       	call   80103610 <mycpu>
801068cb:	89 c7                	mov    %eax,%edi
801068cd:	e8 3e cd ff ff       	call   80103610 <mycpu>
...
8010696b:	5d                   	pop    %ebp
  popcli();
8010696c:	e9 cf d9 ff ff       	jmp    80104340 <popcli>
    panic("switchuvm: no process");
80106971:	c7 04 24 f6 77 10 80 	movl   $0x801077f6,(%esp)
80106978:	e8 e3 99 ff ff       	call   80100360 <panic>
    panic("switchuvm: no pgdir");
8010697d:	c7 04 24 21 78 10 80 	movl   $0x80107821,(%esp)
80106984:	e8 d7 99 ff ff       	call   80100360 <panic>
    panic("switchuvm: no kstack");
80106989:	c7 04 24 0c 78 10 80 	movl   $0x8010780c,(%esp)
...
801069d7:	e8 d4 da ff ff       	call   801044b0 <memset>
...
80106a0b:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80106a0c:	e9 3f db ff ff       	jmp    80104550 <memmove>
    panic("inituvm: more than a page");
80106a11:	c7 04 24 35 78 10 80 	movl   $0x80107835,(%esp)
...
80106ac2:	c7 04 24 4f 78 10 80 	movl   $0x8010784f,(%esp)
...
80106b23:	e8 88 d9 ff ff       	call   801044b0 <memset>
...
80106b61:	c7 04 24 6d 78 10 80 	movl   $0x8010786d,(%esp)
...
80106b90:	c7 04 24 85 78 10 80 	movl   $0x80107885,(%esp)
...
80106c53:	e9 98 b6 ff ff       	jmp    801022f0 <kfree>
    panic("freevm: no pgdir");
80106c58:	c7 04 24 a1 78 10 80 	movl   $0x801078a1,(%esp)
...
80106c9b:	e8 10 d8 ff ff       	call   801044b0 <memset>
...
80106d3b:	c3                   	ret    
    panic("clearpteu");
80106d3c:	c7 04 24 b2 78 10 80 	movl   $0x801078b2,(%esp)
...
80106d8d:	e8 be d7 ff ff       	call   80104550 <memmove>
...
80106e24:	eb d8                	jmp    80106dfe <copyuvm+0xae>
      panic("copyuvm: page not present");
80106e26:	c7 04 24 d6 78 10 80 	movl   $0x801078d6,(%esp)
80106e2d:	e8 2e 95 ff ff       	call   80100360 <panic>
      panic("copyuvm: pte should exist");
80106e32:	c7 04 24 bc 78 10 80 	movl   $0x801078bc,(%esp)
...
80106ebc:	e8 8f d6 ff ff       	call   80104550 <memmove>
    len -= n;
    buf += n;
